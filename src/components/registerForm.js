...
//   addeing new user data to database
  async function registerNew() {
    try {
      const response = await axios.post("https://url-short-ner-6.herokuapp.com//user/register", {
        email: name,
        password: password,
        name: firstName,
      });
      ...
      <div className="containers">
        <div className="form">
          <form onSubmit={handleSubmit}>
            <div className="titles"><p className="welcome">Registration</p></div>

           <input className="form-control text" type="text" value={firstName} name="firstName" placeholder="Enter your Name" required onChange={handleChange} ></input>
           <br />
